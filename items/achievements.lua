...
SMODS.Achievement{
    key="they_disabled",
    loc_txt = {
        name="Achievements Currently Disabled",
        description = "if someone sends in a pr or issue on how to fix the problem with achievements, (there are supposed to be actual achievements here) on the github it would be greatly appreciated"
    },
    atlas="achieve",
    pos={x=1,y=0},
    hidden_pos={x=0,y=0},
